        ...
        public static class GetReviews
        {
            ...
            public static Review[] User(User u)
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        tmpGame = new Game(readerGame.GetInt32(0), readerGame.GetString(1), readerGame.GetString(2), readerGame.GetString(3), readerGame.GetString(5), readerGame.GetDateTime(6), readerGame.GetInt32(7));
                    }
                    readerGame.Close();
                    connUser.Close();
